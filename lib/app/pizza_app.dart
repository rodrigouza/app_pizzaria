          ...
          body: Column(children: [
            Container(
              ...
              child: Stack(children: [
                Container(
                  alignment: Alignment.topCenter,
                  child: Image.network('https://pizzariadesucesso.com/wp-content/uploads/2018/05/pepperoni-pizza.jpg')),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    style: TextStyle(fontSize: 36.0, color: Colors.black, fontWeight: FontWeight.bold)),
                    icon: Icon(Icons.heart_broken, size: 70.0, color: Colors.black45),
                    style: ButtonStyle(
                    alignment: Alignment.centerLeft,
